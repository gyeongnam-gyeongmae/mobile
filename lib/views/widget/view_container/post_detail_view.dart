...
class PostDetailView extends GetView<InfiniteScrollController> {
  ...
  PostDetailView({required this.productDetail, required this.commentCount, super.key});
  ...
  String changeDifTime() {
    ...
    print("현재시간 $now");
    print("마감시간 $dateTime");
    print("시차 ${dateTime.difference(now)}");
    return difTime;
  }
          ...
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            SizedBox(
              ...
              child: TextButton(
                  ...
                  onPressed: () {
                    _PriceDialog(context, productDetail.price + 100).then((value) {
                        if (value == 'OK') {
                          controller.addPrice(1, 100);//id, price
                        }
                      });
                  },
              ...
              child: TextButton(
                  style: TextButton.styleFrom(
                      ...
                      textStyle: const TextStyle(
                          fontSize: 22, fontWeight: FontWeight.bold)),
                  onPressed: () {
                    _PriceDialog(context, productDetail.price + 1000).then((value) {
                        if (value == 'OK') {
                          controller.addPrice(1, 1000);//id, price
                        }
                      });
                  },
              ...
              child: TextButton(
                  style: TextButton.styleFrom(
                      ...
                      textStyle: const TextStyle(
                          fontSize: 22, fontWeight: FontWeight.bold)),
                  onPressed: () {
                    _PriceDialog(context, productDetail.price + 10000).then((value) {
                        if (value == 'OK') {
                          controller.addPrice(1, 10000);//id, price
                        }
                      });
                  },
