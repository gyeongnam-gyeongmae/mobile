                          ...
                          Row(
                            ...
                            children: [
                              Container(
                                ...
                                child: CategoryDropdown(categories: const [
                                  '의류',
                                  '디지털',
                                  '가구',
                                  '기타'
                    ...
                    child: ElevatedButton(
                      style: ElevatedButton.styleFrom(
                        shape: RoundedRectangleBorder(
                          borderRadius:
                              BorderRadius.circular(9.0), // 라운드 모서리 반경 설정
                        ),
                        backgroundColor:
                            const Color.fromARGB(255, 59, 146, 252),
                      ),
                      onPressed: () async {
                        controller.setCloseTime(datePickerController.getDate());
                        controller.setUserId(ProfileController.to.getId());
